...
class Registration extends Component {
      ...
      firebase
        ...
        .then((data) => {
          ...
          const uploadTask = storage
            .ref(`${data.user.uid}/${this.state.upload_file.name}`)
            .put(this.state.upload_file);
          uploadTask.on(
            "state_changed",
            (snapShot) => {
            ...
            () => {
              ...
              storage
                .ref(data.user.uid)
                .child(this.state.upload_file.name)
                .getDownloadURL()
                .then((fireBaseUrl) => {
                  this.setState({
  ...
  render() {
    ...
    return (
      <>
        <MetaTags title={"i69 | Registration"} />
        <Header />
